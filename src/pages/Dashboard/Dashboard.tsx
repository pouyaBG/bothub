import { Bell, ChartBar, Clock, CreditCard, Eye, House, Robot, TrendUp, Users } from 'phosphor-react';
...
const Dashboard: React.FC = () => {
  ...
  const quickActions = [
    { title: "مدیریت کاربران", description: "افزودن و مدیریت کاربران", icon: Users, path: "/user-management" },
    { title: "ارسال پیام", description: "ارسال پیام به کاربران", icon: Bell, path: "/messaging" },
    { title: "گزارشات", description: "مشاهده آمار و گزارشات", icon: ChartBar, path: "/reports" },
    { title: "تنظیمات ربات", description: "پیکربندی ربات‌ها", icon: Robot, path: "/bot-settings" },
  ];

  const recentActivities = [
    { id: 1, text: "کاربر جدید ثبت‌نام کرد", time: "5 دقیقه پیش", type: "user", color: "green" },
    { id: 2, text: "ربات پشتیبانی به‌روزرسانی شد", time: "15 دقیقه پیش", type: "bot", color: "blue" },
    { id: 3, text: "تراکنش جدید انجام شد", time: "30 دقیقه پیش", type: "payment", color: "yellow" },
    { id: 4, text: "پیام جمعی ارسال شد", time: "1 ساعت پیش", type: "message", color: "purple" },
    { id: 5, text: "کاربر از سیستم خارج شد", time: "2 ساعت پیش", type: "auth", color: "red" },
  ];
    ...
    <div className="space-y-6">
            ...
            <div className="flex items-center justify-between">
              <div className="flex-1">
                ...
                <div className={`text-sm flex items-center mt-2 ${
                  ...
                  {stat.trend === "up" && <TrendUp size={16} className="ml-1" />}
                  {stat.trend === "neutral" && <Clock size={16} className="ml-1" />}
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-200">
        <div className="p-6 border-b border-gray-200">
          <h2 className="text-xl font-bold text-gray-900">عملیات سریع</h2>
        </div>
        <div className="p-6">
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center justify-between p-4 bg-yellow-50 rounded-lg border border-yellow-200">
                <div className="flex items-center space-x-3 space-x-reverse">
                  ...
                  <span className="font-medium text-gray-900">پشتیبان‌گیری</span>
                </div>
